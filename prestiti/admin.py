...
class PrestitoAdmin(admin.ModelAdmin):
    ...
    list_display = ['id', 'fk_dispositivo', 'fk_utente', 'tecnico_consegna', 'inizio_prestito', 'tecnico_ritiro', 'fine_prestito', ]
    date_hierarchy = 'inizio_prestito'
    # list_filter =  ['fk_utente', 'tecnico_consegna', 'tecnico_ritiro', 'fk_dispositivo', ]
    # search_fields =  []
    list_filter = ['fk_dispositivo','tecnico_consegna',]
    ordering = ['-inizio_prestito']
    # fields = ('fk_utente', 'fk_dispositivo',('tecnico_consegna','inizio_prestito', ),( 'tecnico_ritiro','fine_prestito',), )
